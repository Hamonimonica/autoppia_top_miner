...
from autoppia_miner.parsing.pruning import strip_presentation_attrs

if TYPE_CHECKING:
    from bs4 import BeautifulSoup

    from autoppia_miner.parsing.candidates import Candidate
...
def _truncate_ir(
    ...
    result.append("")
    budget = char_limit - sum(len(line) + 1 for line in result)
